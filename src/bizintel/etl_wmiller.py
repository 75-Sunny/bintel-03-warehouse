...
Before this, call the dw_create_case_wmiller.py script to create the empty data warehouse.
...
Output:
- artifacts/smart_sales_w.duckdb (populated)

Terminal command to run this file from the root project folder:

uv run python -m bizintel.etl_wmiller
